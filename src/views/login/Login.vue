...
//     clientId: '425522104351-jdajusf5ollgt7ahk1q1pt6o55t8la69.apps.googleusercontent.com', 
//     scope: 'd13652417@gmail.com',
//     redirectUri: 'http://localhost:3000'
// });

// const googleLogin = async () => {
//       try {
//         const googleUser = await oauth2.login();
//         console.log(googleUser);
//         // 登录成功后的处理逻辑，如获取token、用户信息等
//       } catch (error) {
