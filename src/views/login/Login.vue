      ...
      <el-tabs v-model="activeName" class="login-tabs" @tab-click="handleTabclick">
        <el-tab-pane label="Login" name="login" class="lg-pane">
          <el-row justity="center">
            ...
            <el-col :span="24" :push="4" style="margin-top:0;">
        ...
        以 Facebook 账户继续
            ...
            <el-col style="margin-top:-20px;">
              <el-input v-model="email" style="width: 400px;height: 48px;font-size:24px;" placeholder="Email" />
            </el-col>
            <el-col>
              <el-input v-model="pwd" type="Password" style="width: 400px;height: 48px;font-size:24px;" placeholder="Password" />
            </el-col>
            <el-col>
              <el-checkbox v-model="remember" style="width:22px;height:22px;" label="Remember Me"/>
            </el-col>
        ...
        以 Facebook 账户继续
            ...
            <el-col style="margin-top:-20px;">
              <span>Email</span>
              <el-input v-model="sign_email" style="width: 400px;height: 48px;font-size:24px;" />
            </el-col>
            <el-col>
              <span>Password (6 characters minimum)</span>
              <el-input v-model="sign_pwd" style="width: 400px;height: 48px;font-size:24px;" type="password"/>
            </el-col>
            <el-col>
              <span>Password confirmation</span>
              <el-input v-model="sign_confirm_pwd" style="width: 400px;height: 48px;font-size:24px;" type="password"/>
            </el-col>
            <el-col :span="24" :push="8">
